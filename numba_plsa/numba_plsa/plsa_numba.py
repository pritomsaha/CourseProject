...
def plsa_numba(dt_row, dt_col, dt_val, topic_doc, term_topic, n_iter, term_topic_prior, mu):
  ...
  for i in range(n_iter):
    ...
    for z in range(n_topics):
      for t in range(n_terms):
        term_topic[z, t] = (term_topic[z, t] + mu[z]*term_topic_prior[z, t])/ (term_sum[z] + mu[z])
